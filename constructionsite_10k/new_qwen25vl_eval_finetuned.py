"""
独立评估脚本：加载微调后的 Qwen2.5-VL-3B LoRA 模型，在 test.json 上评估
"""
...
EVAL_OUTPUT      = "/root/autodl-tmp/eval_qwen25vl_finetuned.json"
...
# ==================== 3. 评估 ====================
eval_result = evaluate_qwen25vl(
    model, processor, raw_test, IMAGE_ROOT,
    system_prompt=SYSTEM_PROMPT,
    sbert_path=SBERT_PATH,
    desc="Qwen2.5-VL 微调模型评估",
    eval_batch_size=EVAL_BATCH_SIZE,
)

print_results("Qwen2.5-VL-3B 微调模型评估结果", eval_result)
